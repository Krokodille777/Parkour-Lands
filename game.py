...
from sprites import Ground, Player, JumpPad, Lava, Spike, Bridge, Water, Ladder, Accelerator, Decelerator, Checkpoint, FragileGround, ElevatorUpDown, ElevatorLeftRight
...
test_block = Ground(1300, 400, 150, 50)
...
lava_pool = Lava(912, 750, 600, 500)
lava_pool.image.fill((250, 112, 47))    # Orange color for lava



# Colliders list (everything the player can collide with)
colliders = [ground, test_block3, jump_Pad, lava_pool, test_wall, bridge_upon_lava, test_block, test_wall2, elevatorupDown1, elevatorleftRight1]  # Add all collidable objects here
...
dynamic_colliders = [elevatorupDown1, elevatorleftRight1]  # Colliders that can change state (like breaking)
