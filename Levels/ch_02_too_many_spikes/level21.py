...
from sprites import Player, Ground, TipCloud, FinishLevelTrigger, Spike
...
class Level21:
    def __init__(self):
        ...
        spike2 = Spike(600, 700, 35, 50, 0)


        self.triggers = pygame.sprite.Group(spike1, spike2)
        ...
        self.all_sprites.add(spike1, layer = 1)
        self.all_sprites.add(spike2, layer = 1)
